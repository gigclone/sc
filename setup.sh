...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/gigclone/permission/main/A1valid/ip > /root/tmp
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/amirulckck/test/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/amirulckck/prem/main/ip  )
